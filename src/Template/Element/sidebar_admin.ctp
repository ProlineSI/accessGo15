    ...
    <div class="container-fluid container-sidebar">
		...
		<div class="" id="bs-sidebar-navbar-collapse-1">
			<ul class="nav navbar-nav">
				<li><a href="<?= $this->Url->build(['controller' => 'users', 'action' => 'home']);?>"><span class='glyphicon glyphicon-stats iconos-sidebar'></span>Inicio<span style="font-size:16px;" class="pull-right hidden-xs showopacity "></span></a></li>
				<li class="sidebar-dropdown" id='sidebar-dropdown-user'>
					<a href="#"><span class='glyphicon glyphicon-user iconos-sidebar'></span>Invitados<span class="glyphicon glyphicon-menu-down menu-down-user"></span><span style="font-size:16px;" class="pull-right hidden-xs showopacity"></span></a>
				...
				<li class="sidebar-dropdown" id='sidebar-dropdown-events'>
					<a href="#"><span class='glyphicon glyphicon-calendar iconos-sidebar'></span>Ingresados<span class="glyphicon glyphicon-menu-down menu-down-events"></span><span style="font-size:16px;" class="pull-right hidden-xs showopacity"></span></a>
					<div class="sidebar-submenu">
						<ul class="forAnimate">
